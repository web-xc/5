(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
    1: [function (require, module, exports) {
        ...
        q.init = function () {
            ...
            function getProvider(current) {
                ...
                if (typeof providerName === 'string') {
                    ...
                    if (!provider) {
                        console.warn('娌℃湁鎵惧埌鐩稿簲鐨� Provider锛�' + providerName);
                        provider = {};
                    }
            ...
            function initLoad() {
                $lyrics.addClass('QPlayer-lyrics-no').html('<p>鏃犳瓕璇嶏紝璇锋璧忋€�</p>');
                $title.html('<strong>娌℃湁姝屾洸</strong>');
                $lyricsList = null;
            ...
            function initNoSongs() {
                init();
                $listLi = null;
                $list.html('<li class="QPlayer-list-current">娌℃湁姝屾洸</li>');
            }
            ...
            q.load = function (index) {
                ...
                var length = v.list.length;
                if (length === 0) {
                    console.warn('list 涓虹┖锛�');
                    return false;
                }
                if (!(length > index || index > 0)) {
                    console.warn('瓒呭嚭 list锛宭ength=' + length + '锛宨ndex=' + index);
                    return false;
                }
        ...
        $(window.QPlayer.init);
    }, { "blueimp-md5": 2, "jquery": 4, "jquery.simplemarquee": 3, "js-cookie": 5 }], 5: [function (require, module, exports) {
        /*!
